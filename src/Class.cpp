...
std::any Class::call(Interpreter &interpreter,
...
std::string Class::toString() { return "<class " + this->name + ">"; }

int Class::arity() { return 0; }

std::optional<std::shared_ptr<Function>>
